      ...
      <Well>
        <Row>
          ...
          <Col xs={6} sm={8}>
            ...
            <p>{(this.props.description.length > 60 && this.state.isClicked === false)?
                  (this.props.description.substring(0, 60)):(this.props.description)}</p>

            <Button className="link" onClick={this.onReadMore.bind(this)}>
            {(this.state.isClicked === false && this.props.description !== null &&
              this.props.description.length > 60)?('...read more'):('')}
            </Button>
